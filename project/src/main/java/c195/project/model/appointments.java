...
public class appointments {
    ...
    private String type; // can use text field (need to validate for blank) or comboBox
    ...
    private int user_id;
    private int contact_id; // need to use comboBox for contact
    /*
     private date start; // need DatePicker and combo box + time
     private date end; // need DatePicker and combo box + time
    */
